...
if (isNil "keyboard_keys") then {
	...
	_tptoMe = {
		[] execVM "admintools\tools\Teleport\TPtoME.sqf";
		_handled = true;
    };
	_tptoPlayer = {
		[] execVM "admintools\tools\Teleport\TpToPlayer.sqf";
		_handled = true;
    };
	_telePort = {
		[] execVM "admintools\tools\Teleport\Teleport.sqf";
		_handled = true;
    };
	_deleteObject = {
