...
_magicbox setposATL _mypos;
 ...
 _dayz_wep =["Binocular","Binocular_Vector","ItemCompass","ItemEtool","ItemFlashlight","ItemFlashlightRed","ItemGPS","ItemKnife","ItemMap","ItemMatchbox","ItemRadio","ItemWatch","Laserdesignator","NVGoggles","ItemFishingPole","ItemKeyKit"]; 
