...
F5Menu = 
{
	...
	[
		...
		[format["Show tents: %1",AddTentsToMap], [4], "", -5, [["expression", "AddTentsToMap = !AddTentsToMap;changed = true;"]], "1", "1"],
		[format["Show Heli-Crash: %1",AddCrashesToMap], [5], "", -5, [["expression", "AddCrashesToMap = !AddCrashesToMap;changed = true;"]], "1", "1"],
