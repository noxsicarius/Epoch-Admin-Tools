...
_spawnCrate addMagazineCargoGlobal ["ItemGunRackKit", 30];
...
_spawnCrate addMagazineCargoGlobal ["ItemScaffoldingKit", 30];
_spawnCrate addMagazineCargoGlobal ["BagFenceRound_DZ_kit",30];
