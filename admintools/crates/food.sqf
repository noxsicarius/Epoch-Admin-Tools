...
titleText [format["Food Box spawned nearby."],"PLAIN DOWN"]; titleFadeOut 4;
...
sleep 3;
titleText [format["Food Box will disappear in %1 seconds.",SelectDelay],"PLAIN DOWN"]; titleFadeOut 4;

sleep SelectDelay;

deletevehicle _box;

titleText [format["Food Box disappeared."],"PLAIN DOWN"]; titleFadeOut 4;