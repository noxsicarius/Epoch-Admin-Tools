...
// Skins
_box addMagazineCargoGlobal ["Functionary1_EP1_DZ", _itemn];
_box addMagazineCargoGlobal ["SurvivorWpink_DZ", _itemn];
...
titleText [format["VIP Event Box spawned nearby."],"PLAIN DOWN"]; titleFadeOut 4;
