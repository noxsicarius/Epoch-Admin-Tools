...
//	["Safe Zone Create/Delete",[],"", -5, [["expression", format[_EXECscript1,"SafeZoneArea.sqf"]]], "1", "1"],
	...
	["Send Server Message",[],"", -5,[["expression",format[_EXECscript1,"messageDialog.sqf"]]],"1","1"],
...
["",true],	
	...
	["Point to Repair (Temp)", [],"", -5, [["expression", format[_EXECscript1,"PointToRepair.sqf"]]], "1", "1"],
	["Point to Repair (Perm)", [],"", -5, [["expression", format[_EXECscript1,"PointToRepairPERM.sqf"]]], "1", "1"],
	["Point to Revive Vehicle",[],"", -5,[["expression", format[_EXECscript1,"PointToReviveVeh.sqf"]]], "1", "1"],
...
["",true],
	...
	["Building GUI", [],"", -5, [["expression", format[_EXECscript8,"buildingsDialog.sqf"]]], "1", "1"],
