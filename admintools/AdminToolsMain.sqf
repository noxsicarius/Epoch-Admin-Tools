...
_EXECdate = 'EAT_PVEH_SetDate = [%1,%2,%3,%4,0]; setDate EAT_PVEH_SetDate; publicVariableServer "EAT_PVEH_SetDate"';
_EXECcloud = 'EAT_PVEH_SetOvercast = %1; 5 setOvercast EAT_PVEH_SetOvercast; publicVariableServer "EAT_PVEH_SetOvercast"';
_EXECfog = 'EAT_PVEH_SetFog = %1; 5 setFog EAT_PVEH_SetFog; publicVariableServer "EAT_PVEH_SetFog"';
...
// Main weapons like the M4
	...
	EAT_primaryWeaponMenu = EAT_primaryWeaponMenu + [["M4A1 GL SD Camo", [],"", -5, [["expression", format[_EXECweapons,"M4A1_HWS_GL_SD_Camo","30Rnd_556x45_StanagSD","1Rnd_HE_M203"]]], "1", "1"]];
	...
	EAT_primaryWeaponMenu = EAT_primaryWeaponMenu + [["Aks Kobra", [],"", -5, [["expression", format[_EXECweapons,"AKS_74_kobra","30Rnd_545x39_AK","nil"]]], "1", "1"]];
	EAT_primaryWeaponMenu = EAT_primaryWeaponMenu + [["FN FAL", [],"", -5, [["expression", format[_EXECweapons,"FN_FAL","20Rnd_762x51_FNFAL","nil"]]], "1", "1"]];
	EAT_primaryWeaponMenu = EAT_primaryWeaponMenu + [["Mk 48", [],"", -5, [["expression", format[_EXECweapons,"Mk_48_DZ","100Rnd_762x51_M240","nil"]]], "1", "1"]];
	...
	EAT_primaryWeaponMenu = EAT_primaryWeaponMenu + [["DMR", [],"", -5, [["expression", format[_EXECweapons,"DMR","20Rnd_762x51_DMR","nil"]]], "1", "1"]];
	//EAT_primaryWeaponMenu = EAT_primaryWeaponMenu + [["M14 Aim", [],"", -5, [["expression", format[_EXECweapons,"M14_EP1","20Rnd_762x51_DMR","nil"]]], "1", "1"]];
	...
	//EAT_primaryWeaponMenu = EAT_primaryWeaponMenu + [["M16 ACOG", [],"", -5, [["expression", format[_EXECweapons,"m16a4_acg","30Rnd_556x45_Stanag","nil"]]], "1", "1"]];
...
// Sidearm weapons like the Makarov
	...
	EAT_secondaryWeaponMenu = EAT_secondaryWeaponMenu + [["PDW", [],"", -5, [["expression", format[_EXECweapons,"UZI_EP1","30Rnd_9x19_UZI"]]], "1", "1"]];
	EAT_secondaryWeaponMenu = EAT_secondaryWeaponMenu + [["Glock", [],"", -5, [["expression", format[_EXECweapons,"glock17_EP1","17Rnd_9x19_glock17"]]], "1", "1"]];
	EAT_secondaryWeaponMenu = EAT_secondaryWeaponMenu + [["M9 SD", [],"", -5, [["expression", format[_EXECweapons,"M9SD","15Rnd_9x19_M9SD"]]], "1", "1"]];
	EAT_secondaryWeaponMenu = EAT_secondaryWeaponMenu + [["Makarov", [],"", -5, [["expression", format[_EXECweapons,"Makarov","8Rnd_9x18_Makarov"]]], "1", "1"]];
	EAT_secondaryWeaponMenu = EAT_secondaryWeaponMenu + [["Makarov SD", [],"", -5, [["expression", format[_EXECweapons,"MakarovSD","8Rnd_9x18_Makarov"]]], "1", "1"]];
