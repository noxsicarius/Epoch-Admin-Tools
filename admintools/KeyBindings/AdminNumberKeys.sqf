...
1_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 2) then {[] execVM ""admintools\tools\PointToUnlock.sqf"";true};"];
Sleep 0.02;

2_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 3) then {[] execVM ""admintools\tools\PointToLock.sqf"";true};"];
Sleep 0.02;

3_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 4) then {[] execVM ""admintools\tools\gimmecode.sqf"";true};"];
Sleep 0.02;

4_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 5) then {[] execVM ""admintools\tools\givekey.sqf"";true};"];
Sleep 0.02;

5_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 6) then {[] execVM ""admintools\tools\PointToRepairPERM.sqf"";true};"];
Sleep 0.02;
...
9_KEY = (findDisplay 46) displayAddEventHandler ["KeyDown","if ((_this select 1) == 10) then {[] execVM ""admintools\tools\AdminHighlight-Logi.sqf"";true};"];
Sleep 0.02;
